...
Repo Hub is the first step. The CLI, the config schema, the agent templates, the MCP connections — all of it is designed to be adopted, extended, and contributed to by any team.
