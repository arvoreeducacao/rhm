...
- **Kiro**: `.kiro/steering/orchestrator.md`, `.kiro/agents/`, `.kiro/settings/mcp.json`, `AGENTS.md`, `<name>.code-workspace`, `.gitignore`
- **Claude Code**: `CLAUDE.md`, `.claude/agents/`, `.mcp.json`, `.gitignore`
- **OpenCode**: `opencode.json`, `.opencode/rules/`, `.opencode/agents/`, `.opencode/skills/`, `.opencode/commands/`, `.opencode/plugins/`, `.gitignore`
