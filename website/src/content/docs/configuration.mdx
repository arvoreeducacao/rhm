...
- **Autocomplete** for all keys and enum values (tech stacks, MCP packages, Pi toggles)
...
| [`workflow`](/docs/workflow) | Optional conventions (task folder, fact-checker) and prompt customization |
