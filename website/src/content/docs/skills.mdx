...
## Installing from the Community (skills.sh)

Repo Hub is fully compatible with the [skills.sh](https://skills.sh) ecosystem. You can install any skill from any GitHub repository that follows the Agent Skills standard.
...
This points you to [skills.sh](https://skills.sh), the open directory and leaderboard for agent skills.
