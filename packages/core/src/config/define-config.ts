import type { HubConfig, Repo, MCPConfig, Service } from "../types.js";
...
export const mcp = {
  postgresql(name: string, overrides?: MCPOverrides): MCPConfig {
    return { name, package: "@arvoretech/postgresql-mcp", ...overrides, env: { ...overrides?.env } };
  },
  mysql(name: string, overrides?: MCPOverrides): MCPConfig {
    return { name, package: "@arvoretech/mysql-mcp", ...overrides, env: { ...overrides?.env } };
  },
  clickhouse(name: string, overrides?: MCPOverrides): MCPConfig {
    return { name, package: "@arvoretech/clickhouse-mcp", ...overrides, env: { ...overrides?.env } };
  },
  datadog(overrides?: MCPOverrides): MCPConfig {
    return { name: "datadog", package: "@arvoretech/datadog-mcp", ...overrides, env: { ...overrides?.env } };
  },
  memory(overrides?: MCPOverrides): MCPConfig {
    return { name: "team-memory", package: "@arvoretech/memory-mcp", ...overrides, env: { ...overrides?.env } };
  },
  sendgrid(overrides?: MCPOverrides): MCPConfig {
    return { name: "sendgrid", package: "@arvoretech/sendgrid-mcp", ...overrides, env: { ...overrides?.env } };
  },
  launchdarkly(overrides?: MCPOverrides): MCPConfig {
    return { name: "launchdarkly", package: "@arvoretech/launchdarkly-mcp", ...overrides, env: { ...overrides?.env } };
  },
  tempmail(overrides?: MCPOverrides): MCPConfig {
    return { name: "tempmail", package: "@arvoretech/tempmail-mcp", ...overrides, env: { ...overrides?.env } };
  },
  awsSecretsManager(overrides?: MCPOverrides): MCPConfig {
    return { name: "aws-secrets-manager", package: "@arvoretech/aws-secrets-manager-mcp", ...overrides, env: { ...overrides?.env } };
  },
  npmRegistry(overrides?: MCPOverrides): MCPConfig {
    return { name: "npm-registry", package: "@arvoretech/npm-registry-mcp", ...overrides };
  },
  runtimeLens(overrides?: MCPOverrides): MCPConfig {
    return { name: "runtime-lens", package: "@arvoretech/runtime-lens-mcp", ...overrides, env: { ...overrides?.env } };
  },
  meetTranscriptions(overrides?: MCPOverrides): MCPConfig {
    return { name: "meet-transcriptions", package: "@arvoretech/meet-transcriptions-mcp", ...overrides, env: { ...overrides?.env } };
  },
  googleChat(overrides?: MCPOverrides): MCPConfig {
    return { name: "google-chat", package: "@arvoretech/google-chat-mcp", ...overrides, env: { ...overrides?.env } };
  },
  playwright(overrides?: MCPOverrides): MCPConfig {
    return { name: "playwright", package: "@playwright/mcp", ...overrides };
  },
  context7(overrides?: MCPOverrides): MCPConfig {
    return { name: "context7", package: "@upstash/context7-mcp", ...overrides };
  },
  agentTeamsLead(overrides?: MCPOverrides): MCPConfig {
    return { name: "agent-teams-lead", package: "@arvoretech/agent-teams-lead-mcp", ...overrides, env: { ...overrides?.env } };
  },
  agentTeamsChat(overrides?: MCPOverrides): MCPConfig {
    return { name: "agent-teams-chat", package: "@arvoretech/agent-teams-chat-mcp", ...overrides, env: { ...overrides?.env } };
  },
  kanban(overrides?: MCPOverrides): MCPConfig {
    return { name: "kanban", package: "@arvoretech/kanban-mcp", ...overrides, env: { ...overrides?.env } };
  },
  sandbox(port: number = 8080, overrides?: MCPOverrides): MCPConfig {
    return { name: "sandbox", url: `http://localhost:${port}/mcp`, ...overrides };
  },
  proxy(name: string, overrides: MCPOverrides & { upstreams: string[] }): MCPConfig {
    return { name, package: "@arvoretech/mcp-proxy", ...overrides, env: { ...overrides?.env } };
  },
